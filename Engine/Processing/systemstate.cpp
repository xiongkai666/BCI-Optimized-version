    ...
    dataFileReader(dataFileReader_)
{
    ...
    writeToDiskLatency->addItem("Highest", tr("Highest"), 1.0);
    writeToDiskLatency->addItem("High", tr("High"), 4.0);
    writeToDiskLatency->addItem("Medium",tr("Medium"), 16.0);
    writeToDiskLatency->addItem("Low",tr("Low"), 64.0);
    writeToDiskLatency->addItem("Lowest", tr("Lowest"), 256.0);
    ...
    notchFreq->addItem("None", tr("None"), -1.0);
    ...
    arrangeBy->addItem("Channel", tr("Arrange by Channel"), 0);
    arrangeBy->addItem("Filter", tr("Arrange by Filter"), 0);
    ...
    plottingMode->addItem("Original", tr("Original"), 0);
    plottingMode->addItem("High Efficiency",tr("High Efficiency"), 1);
    ...
    displayLabelText->addItem("CustomName", tr("Custom Name"), 0);
    displayLabelText->addItem("NativeName", tr("Native Name"), 1);
    displayLabelText->addItem("ImpedanceMagnitude", tr("Impedance Magnitude"), 2);
    displayLabelText->addItem("ImpedancePhase", tr("Impedance Phase"), 3);
    displayLabelText->addItem("Reference", tr("Reference"), 4);
    displayLabelText->setValue("CustomName");

    labelWidth = new DiscreteItemList("LabelWidth", globalItems, this);
    labelWidth->addItem("Hide", tr("Hide Tags"), 0);
    labelWidth->addItem("Narrow", tr("Narrow Tags"), 1);
    labelWidth->addItem("Wide", tr("Wide Tags"), 2);
    ...
    triggerPolarityPSTH->addItem("Rising", tr("Rising Edge"), +1);
    triggerPolarityPSTH->addItem("Falling", tr("Falling Edge"), -1);
