...
public:
    ...
    static int getBoardMode(CPionway* dev_);
    static int getNumSPIPorts(CPionway *dev_, bool isUSB3, bool& expanderBoardDetected, bool isRHS7310 = false);
...
private:
    ...
    // Pionway module USB interface endpoint addresses common to all controller types
    enum EndPoint {
        WireInResetRun = 0x40,
    ...
    // Pionway module USB interface endpoint addresses common to recorder controller types
    enum EndPointRecord {
    ...
    // Pionway module USB interface endpoint addresses common to USB2 controller types
    enum EndPointUSB2 {
    ...
    // Pionway module USB interface endpoint addresses common to USB3 controller types
    enum EndPointUSB3 {
    ...
    // Pionway module USB interface endpoint addresses unique to ControllerRecordUSB2 type
    ...
    // Pionway module USB interface endpoint addresses unique to ControllerRecordUSB3 type
    ...
    // Pionway module USB interface endpoint addresses unique to ControllerStimRecord
    ...
    // Physical board only
    static void pulseWireIn(CPionway* dev_, int wireIn, unsigned int value);
