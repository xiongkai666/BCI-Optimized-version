...
const QString StimStepSizeString[12] = {
    QObject::tr("minimum step size (imprecise)"),
    PlusMinusSymbol + "2.55 " + MicroAmpsSymbol + QObject::tr(" range(10 nA step size)"),
    PlusMinusSymbol + "5.10 " + MicroAmpsSymbol + QObject::tr(" range (20 nA step size)"),
    PlusMinusSymbol + "12.75 " + MicroAmpsSymbol + QObject::tr(" range (50 nA step size)"),
    PlusMinusSymbol + "25.5 " + MicroAmpsSymbol + QObject::tr(" range (0.1 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + "51.0 " + MicroAmpsSymbol + QObject::tr(" range (0.2 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + "127.5 " + MicroAmpsSymbol + QObject::tr(" range (0.5 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + "255 " + MicroAmpsSymbol + QObject::tr(" range (1 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + "510 " + MicroAmpsSymbol + QObject::tr(" range (2 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + QObject::tr("1.275 mA range (5 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    PlusMinusSymbol + QObject::tr("2.550 mA range (10 ") + MicroAmpsSymbol + QObject::tr(" step size)"),
    QObject::tr("maximum step size (imprecise)")
};
