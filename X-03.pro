...
HEADERS += \
    Engine/API/Hardware/PionwayDLL.h \
...
#INCLUDEPATH += C:/Users/xiongkai/AppData/Local/Programs/Python/Python39/include
#LIBS += -LC:/Users/xiongkai/AppData/Local/Programs/Python/Python39/libs -lpython39

# Windows
win32: {
LIBS += -L$$PWD/libraries/Windows/ -lOpenCL # OpenCL library
LIBS += -L$$PWD/libraries/Windows/ -lPionway # Pionway library
LIBS += -L$$PWD/libraries/Windows/ -ldelayimp # Microsoft's Delay Import library
QMAKE_LFLAGS += /DELAYLOAD:Pionway.dll # Use delayimp to only load Poinway.dll when necessary,
}
