...
#include "../GUI/Dialogs/demodialog.h"
...
QT_MOC_LITERAL(1, 11, 12), // "usbInterface"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16), // "recordController"
QT_MOC_LITERAL(4, 42, 14), // "stimController"
QT_MOC_LITERAL(5, 57, 8), // "playback"
QT_MOC_LITERAL(6, 66, 8) // "advanced"

    },
    "DemoDialog\0usbInterface\0\0recordController\0"
    "stimController\0playback\0advanced"
};
...
void DemoDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DemoDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->usbInterface(); break;
        case 1: _t->recordController(); break;
        case 2: _t->stimController(); break;
        case 3: _t->playback(); break;
        case 4: _t->advanced(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject DemoDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_DemoDialog.data,
    qt_meta_data_DemoDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
